...
/* Big thanks to Trevor Marsh for providing Handler class */
...
public abstract class Handler implements Runnable
{
    ...
    {
        JSONObject json = new JSONObject().put("type", "login");
        json.put("message", new JSONObject().put("username", username));
        send(json);
    }
